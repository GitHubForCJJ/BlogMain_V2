layui.define(['table', 'form', 'element', 'GHM', 'admin', 'view', 'GHM_log', 'laydate', 'GHM_log'], function (exports) {
    ...
    table.render({
        elem: '#LAY-artise-manage'
        , url: GHM_config.url.GetListArtise
        , method: 'post'
        ...
        , cols: [[
            ...
            , { field: 'Extend4', title: '会员昵称', align: 'center' }
            , { field: 'Extend5', title: '会员邮箱', align: 'center' }
            , { field: 'BlogNum', title: '博客编号', align: 'center' }
            , { field: 'Extend6', title: '博客名称', align: 'center' }
    ...
    //监听查询
    form.on('submit(LAY-artise-search)', function (data) {
        var field = data.field;

        var data = { where: field };
        //console.log(data);
        table.reload('LAY-artise-manage', {
    ...
    // table.on('tool(LAY-artise-manage)', function (obj) {
    //     var data = obj.data;
    //     var kid = data.KID;
