layui.define(['table', 'form', 'element', 'GHM', 'admin', 'view', 'GHM_log', 'laydate', 'GHM_log'], function (exports) {
    ...
    table.render({
        ...
        , url: GHM_config.url.GetListAdminComment
        , method: 'post'
        ...
        , cols: [[
            { field: 'KID', title: '序号', align: 'center', width: 80, sort: true }
            , { field: 'Commentid', title: '会话ID', width: 200, align: 'center' }
            , { field: 'BlogNum', title: '博客编号', width: 200, align: 'center' }
            , { field: 'Extend4', title: '博客名称', width: 300, align: 'center' }
            , { field: 'Memberid', title: '会员ID', width: 100, align: 'center' }
            , { field: 'MemberName', title: '会员昵称', width: 200, align: 'center' }
            , { field: 'Avatar', title: '会员头像', align: 'center', width: 100, templet: '#Comment_Avator' }
            , { field: 'ToMemberid', title: '被评论者ID', width: 100, align: 'center' }
    ...
    //点击放大
    $(".layui-card-body").on('click', ".click_img", function () {
